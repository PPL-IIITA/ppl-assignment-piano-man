...
the documentation is provided in the out folder.
Input has been taken from .json files.
In order to execute a file type "node <filename>".
Documentation has been generated using jsdoc.
The node version used to compile the file is 7.4.0.
The class diagram for the corresponding questions has been provided in the "class_diagram.png" file.
